...
export class WebGPURenderer extends WebGPU {
    ...
    useImage(image) {
        ...
        (_a = this.device) === null || _a === void 0 ? void 0 : _a.queue.copyExternalImageToTexture({ source: image, flipY: false, }, { texture, premultipliedAlpha: true }, { width: image.width, height: image.height });
        return texture;
    }
